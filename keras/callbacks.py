...
class BackupAndRestore(Callback):
    ...
    preemption or worker maintenance when doing distributed training with
    ...
    Args:
        ...
        save_freq: `'epoch'`, integer, or `False`. When set to `'epoch'`
          ...
          preemption checkpointing (with `preemption_checkpoint=True`).
        ...
        preemption_checkpoint: A boolean value instructing whether to turn on
          ...
          This only has experimental support for
    ...
    def __init__(
        ...
        self.preemption_checkpoint = preemption_checkpoint
